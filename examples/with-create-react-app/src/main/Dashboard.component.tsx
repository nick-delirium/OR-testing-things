...
import { TailwindWidgetIframe } from '../tailwind/TailwindWidgetIframe.component';
    ...
    <header className="header App-header">
      <div className="list">
        ...
        <div className={'testhide'}>
          this block is hidden by sanitizer
        </div>
        <div className={'testobscure'}>
          this block is obscured by sanitizer
        </div>
        <input
          className="input"
